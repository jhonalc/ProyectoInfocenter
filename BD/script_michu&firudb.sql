-- Crear base de datos
CREATE DATABASE michuyfirudb;
-- Utilizar la base de datos
USE michuyfirudb;
-- Creación de la tabla razas
CREATE TABLE razas(
    id INT PRIMARY KEY AUTO_INCREMENT,
    raza VARCHAR(50) UNIQUE NOT NULL    
);
-- creación de la taba citasmedicas
...
CREATE TABLE citasmedicas(
    ...
    fecha DATE NOT NULL,
    hora TIME NOT NULL,
    nombreAmo VARCHAR(50) NOT NULL,
    apellidoAmo VARCHAR(50) NOT NULL,
    tipoIdentificacion VARCHAR(40) NOT NULL,
    INDEX(idRaza)
);
ALTER TABLE citasmedicas
ADD FOREIGN KEY(idRaza) REFERENCES razas(id);

-- Insertar todas las razas de perros y gatos
